  ...
  module Functions
    ...
    module Metadata
      ...
      DEFINITIONS = {
        ...
        "concat" => { description: "Concatenate values as formatted strings", example: "(concat \"x=\" 10)" },
        "reverse" => { description: "Reverse a list or string", example: "(reverse (list 1 2 3))" },
        "split" => { description: "Split a string by separator", example: "(split \"a,b\" \",\")" },
        "join" => { description: "Join list items into a string", example: "(join (list \"a\" \"b\") \"-\")" },
        "length" => { description: "String/list/hash length", example: "(length (list 1 2 3))" },
        "print" => { description: "Print values without trailing newline", example: "(print \"hello\")" },
        "println" => { description: "Print values with trailing newline", example: "(println \"hello\" 1)" },
